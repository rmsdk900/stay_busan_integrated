...
<style>
.charging_btncancel, .btncharging {
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="chargingForm" action="${pageContext.request.contextPath}/common/charging" method="POST">
            금액 : 
            <input id="charging" type="number" step="10000" min="10000" name="charging" placeholder="금액을 입력하세요.">
            <input type="hidden" value="${userInfo.u_no}" name="u_no"/>
         </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="charging_btncancel" data-dismiss="modal">취소</button>
